...
#   4. Key is stored in ECC slot specified by --label (0-31 available)
...
echo "Generating P-256 key in slot $SLOT"
pkcs11-tool --module "$MODULE" --keypairgen --key-type EC:secp256r1 --label "$SLOT"
